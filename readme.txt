-------------------------------------------------------
    Thank you for downloading nakedpress Theme!
-------------------------------------------------------
This and any other Theme provided by MarchettiDesgin should
...
- Widgets
nakedpress has one sidebar on the right.

- Page Templates
nakedpress has a home page template with one slider that shows the latest three articles.
...
nakedpress use bootstrap grid, menu and slider, also use font awesome for the icons.
...
nakedpress WordPress theme, Copyright (C) 2016 MarchettiDesign
nakedpress WordPress theme is licensed under the GPL.
...
nakedpress uses a modified version of Edward McIntyre’s wp_boot_strap_navwalker  - https://github.com/twittem/wp-bootstrap-navwalker
License: GPL-2.0+
Copyright: Edward McIntyre - @twittem

Everything else used in this theme (including the screenshot.png) has been created by me (Andrea Marchetti), especially for the nakedpress theme and is distributed under GPL v3 license.


-------------------------------------------------------
    Adopting nakedpress Theme (Theme Re-Distribution):
-------------------------------------------------------

It's GPL so yes you can base your Themes from nakedpress
